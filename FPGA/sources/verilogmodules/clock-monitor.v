...
localparam BLINKWIDTH = clogb2(BLINK_HALFPERIOD);  // number of bits to hold blink period
  ...
  (* ASYNC_REG = "TRUE" *) reg ck0_rega;   // 1st synchroniser register on clock 0
  (* ASYNC_REG = "TRUE" *) reg ck0_regb;   // 2nd synchroniser register on clock 0
  reg ck0_regc;                         // previous synchronised value, for edge detect
  (* ASYNC_REG = "TRUE" *) reg ck1_rega;   // 1st synchroniser register on clock 1
  (* ASYNC_REG = "TRUE" *) reg ck1_regb;   // 2nd synchroniser register on clock 1
  reg ck1_regc;                         // previous synchronised value, for edge detect
  (* ASYNC_REG = "TRUE" *) reg ck2_rega;   // 1st synchroniser register on clock 2
  (* ASYNC_REG = "TRUE" *) reg ck2_regb;   // 2nd synchroniser register on clock 2
  reg ck2_regc;                         // previous synchronised value, for edge detect
  (* ASYNC_REG = "TRUE" *) reg ck3_rega;   // 1st synchroniser register on clock 3
  (* ASYNC_REG = "TRUE" *) reg ck3_regb;   // 2nd synchroniser register on clock 3
  reg ck3_regc;                         // previous synchronised value, for edge detect
...
//
  ...
  begin
      ...
      begin
        // ck0
        ck0_regc <= ck0_regb;       // previous value
        ck0_regb <= ck0_rega;       // 2nd register
        ck0_rega <= ck0;            // copy in raw async input
        
        if((ck0_regc==0) && (ck0_regb==1))      // rising edge aclk
        begin
        ...
        // ck1
        ck1_regc <= ck1_regb;       // previous value
        ck1_regb <= ck1_rega;        // 2nd register
        ck1_rega <= ck1;            // copy in raw async input
        
        if((ck1_regc==0) && (ck1_regb==1))      // rising edge aclk
        begin
        ...
        // ck2
        ck2_regc <= ck2_regb;       // previous value
        ck2_regb <= ck2_rega;       // 2nd register
        ck2_rega <= ck2;            // copy in raw async input
        
        if((ck2_regc==0) && (ck2_regb==1))      // rising edge aclk
        begin
        ...
        // ck3
        ck3_regc <= ck3_regb;       // previous value
        ck3_regb <= ck3_rega;       // 2nd register
        ck3_rega <= ck3;            // copy in raw async input
        
        if((ck3_regc==0) && (ck3_regb==1))      // rising edge aclk
        begin
